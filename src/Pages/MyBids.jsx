...
const MyBids = () => {
 ...
 useEffect(()=> {
  ...
  const getData = async() => {
    const {data} = await axiosSecure(`/myBid/${user?.email}`)
    setBids(data);
  }
                  ...
                  bids.map(bid => 
                    ...
                    <td className='px-4 py-4 text-sm whitespace-nowrap'>
                      <div className='flex items-center gap-x-2'>
                        <p
                          className={`px-3 py-1 rounded-full ${bid.category === 'web development' && 'text-blue-500 bg-blue-100/60'}   ${bid.category === 'graphics design' && 'text-emerald-500 bg-emerald-100/60'} ${bid.category === 'digital marketing' && 'text-pink-500 bg-pink-100/60'}
                           text-xs`}
                        >
                          {bid.category}
                        </p>
                    ...
                    <td className='px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap'>
                      ...
                      <div className={`inline-flex items-center px-3 py-1 rounded-full gap-x-2 ${bid.status === 'pending' && 'bg-yellow-100/60 text-yellow-500'}
