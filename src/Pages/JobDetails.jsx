...
const JobDetails = () => {
    ...
    const {_id, buyer, jobTitle, category, dateline, description, min_price, max_price} = job || {};
    console.log(user);
    const handleFormSubmit = async (e) => {
      ...
      if(price < parseFloat(min_price)) return toast.error('Offer more or al least equal to minimum price')
      ...
      const bidData = {
            jobId, price, dateLine, comment, email, buyer_email:buyer?.email, status, jobTitle, category, buyer
      } 
      try {
          const {data} = await axiosSecure.post(`/bid`, bidData);
          console.log(data);
          toast.success('Place a bid successful')
      } catch(err) {
        console.log(err);
